...
type DecimalSeparatorFieldProps = {
  value: string;
  onChange: (value: string) => void;
};

const decimalSeparatorOptions = ["Period (.)", "Comma (,)"];

export function DecimalSeparatorField({
  value,
  onChange,
}: DecimalSeparatorFieldProps) {
  ...
  return (
    <div>
      <label className="block text-xs  text-slate-900 mb-2">
        {t("settings.sections.localization.decimalSeparator")}
      </label>
