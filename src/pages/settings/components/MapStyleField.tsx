...
type MapStyleFieldProps = {
  value: string;
  onChange: (value: string) => void;
};

const mapStyleOptions = ["Google Maps", "Mapbox", "OpenStreetMap"];

export function MapStyleField({ value, onChange }: MapStyleFieldProps) {
  ...
  return (
    <div>
      <label className="block text-xs  text-slate-900 mb-2">
        {t("settings.sections.general.mapStyle")}
      </label>
